...
const GROUPS: NavGroup[] = [
  {
    ...
    items: [
      ...
      { href: "/cms/hero", label: "Hero Slides", icon: <Icon d="M7 4v16M17 4v16M3 8h4m10 0h4M3 12h18M3 16h4m10 0h4M4 4h16a1 1 0 011 1v14a1 1 0 01-1 1H4a1 1 0 01-1-1V5a1 1 0 011-1z" /> },
      ...
      { href: "/cms/circuits", label: "Circuits", icon: <Icon d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7" /> },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/cms/footer", label: "Footer", icon: <Icon d="M4 5h16a1 1 0 011 1v12a1 1 0 01-1 1H4a1 1 0 01-1-1V6a1 1 0 011-1z M3 15h18" /> },
